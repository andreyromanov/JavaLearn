                    ...
                    <div class="panel-body">
                        <form action="/teacher/themes/update/{{$teachTheme->theme_id}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="text" name="a{{$j}}{{$i}}" class="form-control" style="width:90%;display:inline;" required="" value="{{$answer->answers_text}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="a1{{$i}}" class="form-control" style="display:inline;" value="{{$answer->answers_text}}" required="">
...
<?$k=1?>
                                ...
                                <div class="row">
                  <div class="col-md-4">
                    <input type="text" name="LP{{$k}}" class="form-control" value="{{$accs->LP}}" required="">
                    <br></div>
                  <div class="col-md-4">
                    <input type="text" name="RP{{$k}}" class="form-control" value="{{$accs->RP}}" required="">
                    <br>
                    </div>
                  <div class="col-md-2">
                    <input type="text" name="LA{{$k}}" class="form-control" value="{{$accs->LA}}" required="">
                    <br></div>
                  <div class="col-md-2">
                    <input type="text" name="RA{{$k}}" class="form-control" value="{{$accs->RA}}" required="">
                    <br>
                    </div>
                    <input type="text" name="accordance_id{{$k}}" value="{{$accs->accordance_id}}" style="display: none;">
                </div>
