          ...
          <div class="panel-body">
            <form action="/teacher/themes/newtheme/create" method="POST">
              ...
              <div class="form-group">
                ...
                <br>
                <div class="col-md-3"><input type="text" name="a11" class="form-control"
                    style="width:90%;display:inline;" placeholder="Вариант 1" required="">
                ...
                <div class="col-md-3"><input type="text" name="a21" class="form-control"
                    style="width:90%;display:inline;" placeholder="Вариант 2" required="">
                  <input class="form-check-input" style="float: right;margin-top: 10px;transform: scale(1.3);"
                    type="checkbox" name="ca21" value="1" id="defaultCheck1">
                </div>
                <div class="col-md-3"><input type="text" name="a31" class="form-control"
                    style="width:90%;display:inline;" placeholder="Вариант 3" required="">
                  <input class="form-check-input" style="float: right;margin-top: 10px;transform: scale(1.3);"
                    type="checkbox" name="ca31" value="1" id="defaultCheck1">
                </div>
                <div class="col-md-3"><input type="text" name="a41" class="form-control"
                    style="width:90%;display:inline;" placeholder="Вариант 4" required="">
                  <input class="form-check-input" style="float: right;margin-top: 10px;transform: scale(1.3);"
              ...
              <div class="form-group">
                ...
                <br>
                <div class="col-md-3"><input type="text" name="a12" class="form-control"
                    style="width:90%;display:inline;" placeholder="Вариант 1" required="">
                  <input class="form-check-input" style="float: right;margin-top: 10px;transform: scale(1.3);"
                    type="checkbox" name="ca12" value="1" id="defaultCheck1">
                </div>
                <div class="col-md-3"><input type="text" name="a22" class="form-control"
                    style="width:90%;display:inline;" placeholder="Вариант 2" required="">
                  <input class="form-check-input" style="float: right;margin-top: 10px;transform: scale(1.3);"
                    type="checkbox" name="ca22" value="1" id="defaultCheck1">
                </div>
                <div class="col-md-3"><input type="text" name="a32" class="form-control"
                    style="width:90%;display:inline;" placeholder="Вариант 3" required="">
                  <input class="form-check-input" style="float: right;margin-top: 10px;transform: scale(1.3);"
                    type="checkbox" name="ca32" value="1" id="defaultCheck1">
                </div>
                <div class="col-md-3"><input type="text" name="a42" class="form-control"
                    style="width:90%;display:inline;" placeholder="Вариант 4" required="">
                  <input class="form-check-input" style="float: right;margin-top: 10px;transform: scale(1.3);"
              ...
              <div class="form-group">
                ...
                <br>
                <div class="col-md-3"><input type="text" name="a13" class="form-control"
                    style="width:90%;display:inline;" placeholder="Вариант 1" required="">
                  <input class="form-check-input" style="float: right;margin-top: 10px;transform: scale(1.3);"
                    type="checkbox" name="ca13" value="1" id="defaultCheck1">
                </div>
                <div class="col-md-3"><input type="text" name="a23" class="form-control"
                    style="width:90%;display:inline;" placeholder="Вариант 2" required="">
                  <input class="form-check-input" style="float: right;margin-top: 10px;transform: scale(1.3);"
                    type="checkbox" name="ca23" value="1" id="defaultCheck1">
                </div>
                <div class="col-md-3"><input type="text" name="a33" class="form-control"
                    style="width:90%;display:inline;" placeholder="Вариант 3" required="">
                  <input class="form-check-input" style="float: right;margin-top: 10px;transform: scale(1.3);"
                    type="checkbox" name="ca33" value="1" id="defaultCheck1">
                </div>
                <div class="col-md-3"><input type="text" name="a43" class="form-control"
                    style="width:90%;display:inline;" placeholder="Вариант 4" required="">
                  <input class="form-check-input" style="float: right;margin-top: 10px;transform: scale(1.3);"
              ...
              <div class="form-group">
                ...
                <br>
                <div class="col-md-3"><input type="text" name="a14" class="form-control"
                    style="width:90%;display:inline;" placeholder="Вариант 1" required="">
                  <input class="form-check-input" style="float: right;margin-top: 10px;transform: scale(1.3);"
                    type="checkbox" name="ca14" value="1" id="defaultCheck1">
                </div>
                <div class="col-md-3"><input type="text" name="a24" class="form-control"
                    style="width:90%;display:inline;" placeholder="Вариант 2" required="">
                  <input class="form-check-input" style="float: right;margin-top: 10px;transform: scale(1.3);"
                    type="checkbox" name="ca24" value="1" id="defaultCheck1">
                </div>
                <div class="col-md-3"><input type="text" name="a34" class="form-control"
                    style="width:90%;display:inline;" placeholder="Вариант 3" required="">
                  <input class="form-check-input" style="float: right;margin-top: 10px;transform: scale(1.3);"
                    type="checkbox" name="ca34" value="1" id="defaultCheck1">
                </div>
                <div class="col-md-3"><input type="text" name="a44" class="form-control"
                    style="width:90%;display:inline;" placeholder="Вариант 4" required="">
                  <input class="form-check-input" style="float: right;margin-top: 10px;transform: scale(1.3);"
